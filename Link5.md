...
*The HTML coding language follows the basic rules of XML language that was published in 2000 and it allowed people to write their oun markup langauge*


## 1- **DOCTYPES**


 **When writing HTML language, each page must start with a DOCTYPE.**
...
The new HTML5 enable the developers to divide up the the differnt sections on their web page without using ```<div>``` element. The ```<div>``` elemnt is a meaningless element was used by the old version of HTML to divide up their sections or parts of the web page and indifiy evey section or a part with its own attribute. however, with new virsion of HTML5 developers can replace ```<div>``` by the direct describtion of the section. they are helpful in two ways:
...
|--------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| ```<header>``` ```<\header>``` |the main header appeares at the top of the page and it is used to interduce the for  example the logo and the navigation bar and it can also used inside each section| 
| ```<footer>``` ```<\footer>``` | The footer appeares at the bottom of the page and it is used to interdue the links to socail media and the copy right information|
...
|```<aside>``` ```<\aside>``` |   used to represent content that is related to the surrounding content within the articale|
...
|```<div>``` ```<\div>```    |  used to divide a HTML file into sections|
